...
from pandapower import pandapowerNet, drop_lines
...
def random_disconnect_devices(net: pandapowerNet, device_type: str, probs: DictConfig, black_list: list = None) -> None:
    """Randomly disconnect devices."""
    devices = net[device_type]
    ...
    if device_type == 'line':
        drop_lines(net, disconnected_objects)
    else:
